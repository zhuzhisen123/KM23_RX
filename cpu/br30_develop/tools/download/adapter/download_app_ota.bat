...
..\..\isd_download.exe ..\..\isd_config.ini -tonorflash -dev br30 -boot 0x2000 -div8 -wait 300 -uboot ..\..\uboot.boot -app ..\..\app.bin ..\..\cfg_tool.bin -res p11_code.bin tone.cfg config.dat md5.bin -uboot_compress 
:: -format all
::-reboot 2500
