...
//                               按键转换表                                 //
//*********************************************************************************//
extern u16 adkey_event_to_msg(struct key_event *key);
extern u16 iokey_event_to_msg(struct key_event *key);
extern u16 irkey_event_to_msg(struct key_event *key);
extern u16 rdec_key_event_to_msg(struct key_event *key);
extern u16 touch_key_event_to_msg(struct key_event *key);
