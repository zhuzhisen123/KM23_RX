...
u32 MCU_SRAMToUSB_app(void *hdl, u8 *pBuf, u16 uCount)
{
    return msd_mcu2usb(hdl, pBuf, uCount);
}
u32 MCU_USBToSRAM_app(void *hdl, u8 *pBuf, u16 uCount)
{
