...
*********************************************************************
*/
static int digital_vol_level_to_gain(int level)
{
    if (level > DIGITAL_VOL_MAX) {
        level = DIGITAL_VOL_MAX;
    }
    return dig_vol_table[level];
}
...
*********************************************************************
*/
static int digital_vol_gain_to_level(int gain)
{
    for (int i = 0; i < DIGITAL_VOL_MAX; i++) {
        if (gain <= dig_vol_table[i]) {
            return i;
        }
    }
    return DIGITAL_VOL_MAX;
}
