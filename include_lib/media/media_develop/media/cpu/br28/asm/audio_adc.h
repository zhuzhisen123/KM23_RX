...
#define LADC_MIC_MASK			(AUDIO_ADC_MIC_0)
#define LADC_LINE0_MASK			(AUDIO_ADC_LINE1 | AUDIO_ADC_LINE2)
#define LADC_LINE1_MASK			(AUDIO_ADC_LINE3)

/*LINEIN通道定义*/
//28 有4个LADC通道 可自由组合linein 不支持模拟输入
//BIT(0-3):PA1 PA3 PG8 PG6
#define AUDIO_LIN0L_CH			BIT(1)//
#define AUDIO_LIN0R_CH			BIT(2)//
#define AUDIO_LIN1L_CH			BIT(2)//
#define AUDIO_LIN1R_CH			BIT(3)//
#define AUDIO_LIN2L_CH			BIT(4)//不支持
#define AUDIO_LIN2R_CH			BIT(5)//不支持
#define AUDIO_LIN_DACL_CH		BIT(6) //28不支持
#define AUDIO_LIN_DACR_CH		BIT(7)//28不支持
