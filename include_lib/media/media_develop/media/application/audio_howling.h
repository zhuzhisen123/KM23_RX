...
HOWLING_API_STRUCT *audio_open_howling(u32 howling_name, void *howl_para, u16 sample_rate, u8 channel, u8 mode);
void audio_close_howling(HOWLING_API_STRUCT *howling_hdl);
void audio_update_howling_parm(u32 howling_name, void *parm);
void audio_howling_update_bypass(u32 howling_name, u8 bypass);
#endif
